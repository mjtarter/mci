var map;
    ...
    function mapInit(){
        ...
        map = new google.maps.Map(document.getElementById("dorm-map"), mapOptions);
            ...
            $.each(json, function(i,item){
                ...
                var infowindow = new google.maps.InfoWindow({
                    content: '<img src="assets/dorms/' + item.name + '-1.jpg" class="mtb-5" id="gmap-iw-img">' +
		  			...
		  			'<a href="dorm/show?name=' + item.name + '" target=_blank class="button blue-button" id="listing-btn"><strong>More Info</strong></a>'  
                });
